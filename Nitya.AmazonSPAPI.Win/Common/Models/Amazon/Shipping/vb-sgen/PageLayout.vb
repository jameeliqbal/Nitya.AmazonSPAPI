...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class PageLayout
        Implements IEquatable(Of PageLayout), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class PageLayout {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, PageLayout))
        End Function

        Public Function Equals(ByVal input As PageLayout) As Boolean
