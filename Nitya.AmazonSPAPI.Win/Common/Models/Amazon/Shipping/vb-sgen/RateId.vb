...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class RateId
        Implements IEquatable(Of RateId), IValidatableObject
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, RateId))
        End Function

        Public Function Equals(ByVal input As RateId) As Boolean
