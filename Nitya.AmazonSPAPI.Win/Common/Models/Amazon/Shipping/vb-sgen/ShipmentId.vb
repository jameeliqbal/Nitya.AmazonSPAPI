...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class ShipmentId
        Implements IEquatable(Of ShipmentId), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class ShipmentId {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, ShipmentId))
        End Function

        Public Function Equals(ByVal input As ShipmentId) As Boolean
