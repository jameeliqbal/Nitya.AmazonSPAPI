...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class GetAdditionalInputsResult
        Inherits Dictionary(Of String, Object)
        Implements IEquatable(Of GetAdditionalInputsResult), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class GetAdditionalInputsResult {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, GetAdditionalInputsResult))
        End Function

        Public Function Equals(ByVal input As GetAdditionalInputsResult) As Boolean
