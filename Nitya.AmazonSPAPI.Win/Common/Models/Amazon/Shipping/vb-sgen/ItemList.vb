...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class ItemList
        ...
        Implements IEquatable(Of ItemList), IValidatableObject
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, ItemList))
        End Function

        Public Function Equals(ByVal input As ItemList) As Boolean
