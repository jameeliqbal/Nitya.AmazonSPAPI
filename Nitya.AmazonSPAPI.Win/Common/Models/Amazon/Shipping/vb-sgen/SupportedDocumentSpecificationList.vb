...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class SupportedDocumentSpecificationList
        Inherits List(Of SupportedDocumentSpecification)
        Implements IEquatable(Of SupportedDocumentSpecificationList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class SupportedDocumentSpecificationList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, SupportedDocumentSpecificationList))
        End Function

        Public Function Equals(ByVal input As SupportedDocumentSpecificationList) As Boolean
