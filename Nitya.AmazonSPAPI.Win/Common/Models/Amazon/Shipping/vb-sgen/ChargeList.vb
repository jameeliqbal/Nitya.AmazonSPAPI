...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class ChargeList
        Inherits List(Of ChargeComponent)
        Implements IEquatable(Of ChargeList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class ChargeList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, ChargeList))
        End Function

        Public Function Equals(ByVal input As ChargeList) As Boolean
