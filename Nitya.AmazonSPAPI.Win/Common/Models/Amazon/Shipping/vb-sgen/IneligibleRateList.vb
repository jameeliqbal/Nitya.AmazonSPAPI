...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class IneligibleRateList
        Inherits List(Of IneligibleRate)
        Implements IEquatable(Of IneligibleRateList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class IneligibleRateList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, IneligibleRateList))
        End Function

        Public Function Equals(ByVal input As IneligibleRateList) As Boolean
