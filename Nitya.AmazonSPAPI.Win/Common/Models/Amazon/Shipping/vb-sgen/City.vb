...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class City
        Implements IEquatable(Of City), IValidatableObject
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, City))
        End Function

        Public Function Equals(ByVal input As City) As Boolean
