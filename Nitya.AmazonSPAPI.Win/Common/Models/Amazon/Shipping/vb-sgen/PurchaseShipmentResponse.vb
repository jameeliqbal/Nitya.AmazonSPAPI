...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class PurchaseShipmentResponse
        Implements IEquatable(Of PurchaseShipmentResponse), IValidatableObject

        Public Sub New(ByVal Optional payload As PurchaseShipmentResult = Nothing)
            Me.Payload = payload
        End Sub

        <DataMember(Name:="payload", EmitDefaultValue:=False)>
        Public Property Payload As PurchaseShipmentResult

        Public Overrides Function ToString() As String
            Dim sb = New StringBuilder()
            sb.Append("class PurchaseShipmentResponse {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, PurchaseShipmentResponse))
        End Function

        Public Function Equals(ByVal input As PurchaseShipmentResponse) As Boolean
