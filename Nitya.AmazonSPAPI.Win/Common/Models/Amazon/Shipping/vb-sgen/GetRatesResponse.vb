...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class GetRatesResponse
        Implements IEquatable(Of GetRatesResponse), IValidatableObject

        Public Sub New(ByVal Optional payload As GetRatesResult = Nothing)
            Me.Payload = payload
        End Sub

        <DataMember(Name:="payload", EmitDefaultValue:=False)>
        Public Property Payload As GetRatesResult

        Public Overrides Function ToString() As String
            Dim sb = New StringBuilder()
            sb.Append("class GetRatesResponse {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, GetRatesResponse))
        End Function

        Public Function Equals(ByVal input As GetRatesResponse) As Boolean
