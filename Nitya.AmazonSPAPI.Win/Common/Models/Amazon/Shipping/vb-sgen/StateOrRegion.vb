...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class StateOrRegion
        Implements IEquatable(Of StateOrRegion), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class StateOrRegion {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, StateOrRegion))
        End Function

        Public Function Equals(ByVal input As StateOrRegion) As Boolean
