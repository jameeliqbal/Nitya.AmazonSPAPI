...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class TaxDetailList
        Inherits List(Of TaxDetail)
        Implements IEquatable(Of TaxDetailList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class TaxDetailList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, TaxDetailList))
        End Function

        Public Function Equals(ByVal input As TaxDetailList) As Boolean
