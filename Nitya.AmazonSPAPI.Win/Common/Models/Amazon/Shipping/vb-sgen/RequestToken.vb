...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class RequestToken
        Implements IEquatable(Of RequestToken), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class RequestToken {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, RequestToken))
        End Function

        Public Function Equals(ByVal input As RequestToken) As Boolean
