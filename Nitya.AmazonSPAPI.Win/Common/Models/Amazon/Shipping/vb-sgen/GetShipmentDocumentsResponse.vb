...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class GetShipmentDocumentsResponse
        Implements IEquatable(Of GetShipmentDocumentsResponse), IValidatableObject

        Public Sub New(ByVal Optional payload As GetShipmentDocumentsResult = Nothing)
            Me.Payload = payload
        End Sub

        <DataMember(Name:="payload", EmitDefaultValue:=False)>
        Public Property Payload As GetShipmentDocumentsResult

        Public Overrides Function ToString() As String
            Dim sb = New StringBuilder()
            sb.Append("class GetShipmentDocumentsResponse {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, GetShipmentDocumentsResponse))
        End Function

        Public Function Equals(ByVal input As GetShipmentDocumentsResponse) As Boolean
