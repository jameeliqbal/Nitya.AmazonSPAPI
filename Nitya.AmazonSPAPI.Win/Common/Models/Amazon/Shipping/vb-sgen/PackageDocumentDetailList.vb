...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class PackageDocumentDetailList
        Inherits List(Of PackageDocumentDetail)
        Implements IEquatable(Of PackageDocumentDetailList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class PackageDocumentDetailList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, PackageDocumentDetailList))
        End Function

        Public Function Equals(ByVal input As PackageDocumentDetailList) As Boolean
