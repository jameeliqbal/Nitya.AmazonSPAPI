...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class PackageList
        Inherits List(Of Package)
        Implements IEquatable(Of PackageList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class PackageList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, PackageList))
        End Function

        Public Function Equals(ByVal input As PackageList) As Boolean
