...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class CarrierName
        Implements IEquatable(Of CarrierName), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class CarrierName {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, CarrierName))
        End Function

        Public Function Equals(ByVal input As CarrierName) As Boolean
