...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class DirectPurchaseResponse
        Implements IEquatable(Of DirectPurchaseResponse), IValidatableObject

        Public Sub New(ByVal Optional payload As DirectPurchaseResult = Nothing)
            Me.Payload = payload
        End Sub

        <DataMember(Name:="payload", EmitDefaultValue:=False)>
        Public Property Payload As DirectPurchaseResult

        Public Overrides Function ToString() As String
            Dim sb = New StringBuilder()
            sb.Append("class DirectPurchaseResponse {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, DirectPurchaseResponse))
        End Function

        Public Function Equals(ByVal input As DirectPurchaseResponse) As Boolean
