...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class Contents
        Implements IEquatable(Of Contents), IValidatableObject
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, Contents))
        End Function

        Public Function Equals(ByVal input As Contents) As Boolean
