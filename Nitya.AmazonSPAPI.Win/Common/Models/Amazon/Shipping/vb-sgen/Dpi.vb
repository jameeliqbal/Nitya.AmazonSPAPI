...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class Dpi
        Implements IEquatable(Of Dpi), IValidatableObject
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, Dpi))
        End Function

        Public Function Equals(ByVal input As Dpi) As Boolean
