...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class ServiceName
        Implements IEquatable(Of ServiceName), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class ServiceName {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, ServiceName))
        End Function

        Public Function Equals(ByVal input As ServiceName) As Boolean
