...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class RequestedValueAddedServiceList
        Inherits List(Of RequestedValueAddedService)
        Implements IEquatable(Of RequestedValueAddedServiceList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class RequestedValueAddedServiceList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, RequestedValueAddedServiceList))
        End Function

        Public Function Equals(ByVal input As RequestedValueAddedServiceList) As Boolean
