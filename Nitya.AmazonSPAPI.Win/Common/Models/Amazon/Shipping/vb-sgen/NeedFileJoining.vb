...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class NeedFileJoining
        Implements IEquatable(Of NeedFileJoining), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class NeedFileJoining {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, NeedFileJoining))
        End Function

        Public Function Equals(ByVal input As NeedFileJoining) As Boolean
