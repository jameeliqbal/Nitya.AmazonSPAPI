...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class AvailableValueAddedServiceGroupList
        Inherits List(Of AvailableValueAddedServiceGroup)
        Implements IEquatable(Of AvailableValueAddedServiceGroupList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class AvailableValueAddedServiceGroupList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, AvailableValueAddedServiceGroupList))
        End Function

        Public Function Equals(ByVal input As AvailableValueAddedServiceGroupList) As Boolean
