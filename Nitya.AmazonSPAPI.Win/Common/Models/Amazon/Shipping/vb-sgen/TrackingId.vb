...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class TrackingId
        Implements IEquatable(Of TrackingId), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class TrackingId {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, TrackingId))
        End Function

        Public Function Equals(ByVal input As TrackingId) As Boolean
