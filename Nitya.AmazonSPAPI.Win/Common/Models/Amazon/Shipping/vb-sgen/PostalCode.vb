...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class PostalCode
        Implements IEquatable(Of PostalCode), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class PostalCode {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, PostalCode))
        End Function

        Public Function Equals(ByVal input As PostalCode) As Boolean
