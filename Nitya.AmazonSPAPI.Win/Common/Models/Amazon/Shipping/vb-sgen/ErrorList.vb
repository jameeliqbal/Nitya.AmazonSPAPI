...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class ErrorList
        Inherits List(Of [Error])
        Implements IEquatable(Of ErrorList), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class ErrorList {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, ErrorList))
        End Function

        Public Function Equals(ByVal input As ErrorList) As Boolean
