...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class CountryCode
        Implements IEquatable(Of CountryCode), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class CountryCode {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, CountryCode))
        End Function

        Public Function Equals(ByVal input As CountryCode) As Boolean
