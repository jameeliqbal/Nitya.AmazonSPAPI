...
Namespace Common.Models.Amzn.Shipping
    <DataContract>
    Public Partial Class PackageClientReferenceId
        Implements IEquatable(Of PackageClientReferenceId), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class PackageClientReferenceId {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, PackageClientReferenceId))
        End Function

        Public Function Equals(ByVal input As PackageClientReferenceId) As Boolean
