...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class CarrierId
        Implements IEquatable(Of CarrierId), IValidatableObject
        ...
        Public Overrides Function ToString() As String
            ...
            sb.Append("class CarrierId {" & vbLf)
            sb.Append("}" & vbLf)
            Return sb.ToString()
        End Function
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, CarrierId))
        End Function

        Public Function Equals(ByVal input As CarrierId) As Boolean
