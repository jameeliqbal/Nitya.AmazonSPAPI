...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class RateList
        Inherits List(Of Rate)
        Implements IEquatable(Of RateList), IValidatableObject
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, RateList))
        End Function

        Public Function Equals(ByVal input As RateList) As Boolean
