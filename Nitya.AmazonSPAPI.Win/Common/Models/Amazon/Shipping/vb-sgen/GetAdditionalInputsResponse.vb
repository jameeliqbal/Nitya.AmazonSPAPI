...
Namespace Common.Models.Amzn.Shipping
    ...
    Public Partial Class GetAdditionalInputsResponse
        Implements IEquatable(Of GetAdditionalInputsResponse), IValidatableObject

        Public Sub New(ByVal Optional payload As GetAdditionalInputsResult = Nothing)
            Me.Payload = payload
        End Sub

        <DataMember(Name:="payload", EmitDefaultValue:=False)>
        Public Property Payload As GetAdditionalInputsResult

        Public Overrides Function ToString() As String
            Dim sb = New StringBuilder()
            sb.Append("class GetAdditionalInputsResponse {" & vbLf)
        ...
        Public Overrides Function Equals(ByVal input As Object) As Boolean
            Return Me.Equals(TryCast(input, GetAdditionalInputsResponse))
        End Function

        Public Function Equals(ByVal input As GetAdditionalInputsResponse) As Boolean
