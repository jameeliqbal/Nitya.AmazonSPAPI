...
namespace Common.Models.Amzn.Shipping
{
    ...
    /// </summary>
    [DataContract]
    public partial class DirectPurchaseResponse :  IEquatable<DirectPurchaseResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DirectPurchaseResponse);
        }

        /// <summary>
        /// Returns true if DirectPurchaseResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectPurchaseResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectPurchaseResponse input)
        {
            if (input == null)
                return false;
