...
namespace Common.Models.Amzn.Shipping
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        public Address(string name = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string companyName = default(string), StateOrRegion stateOrRegion = default(StateOrRegion), City city = default(City), CountryCode countryCode = default(CountryCode), PostalCode postalCode = default(PostalCode), string email = default(string), string phoneNumber = default(string))
        {
